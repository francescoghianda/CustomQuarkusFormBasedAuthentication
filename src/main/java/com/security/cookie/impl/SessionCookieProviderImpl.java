...
@ApplicationScoped
public class SessionCookieProviderImpl implements SessionCookieProvider {
    ...
    @Inject
    public SessionCookieProviderImpl(Encryptor encryptor, SecurityConfiguration config){
