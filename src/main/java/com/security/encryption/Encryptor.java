...
public class Encryptor {
    ...
    @Inject
    public Encryptor(SecurityConfiguration config) throws NoSuchAlgorithmException, InvalidKeySpecException, NoSuchPaddingException, InvalidParameterSpecException, InvalidKeyException, InvalidAlgorithmParameterException {
